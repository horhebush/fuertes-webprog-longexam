...
const SignUpPage = () => {
  return (
    <>
      <h1 className="text-3xl font-bold tracking-tight text-navy sm:text-4xl">Sign Up</h1>
      ...
      <div className="mt-8 border-t border-zinc-200 pt-6 text-sm text-zinc-600">
        ...
        <Link to="/auth/signin" className="font-semibold text-[#F5A623] transition hover:text-[#003087]">
          Sign In
        </Link>
      </div>
    </>
